"""s_06_ep_07 v02: v01 with enough trees for early stopping to trigger.

v01 hit the n_estimators=1000 cap on every fold (still improving), so raise
the cap to 8000 and rely on early stopping. Also report per-class recall.
"""
...
submission.to_csv("submissions/submission_v02.csv", index=False)
